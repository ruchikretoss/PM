...
function Pricing() {
    ...
    const renderItem = (service) => {
        ...
        return (
            <div
                key={service.id}
                className={`luxury-menu-card rounded-2xl border transition-all duration-500 overflow-hidden ${
                    isOpen ? "luxury-menu-card-open shadow-[0_15px_30px_rgba(0,0,0,0.05)]" : "shadow-none"
                }`}
                style={{
            ...
            >
                ...
                >
                    {/* Title */}
                    <span
                        className="text-lg uppercase tracking-[1.5px] leading-tight font-extrabold text-[#111111]"
                ...
                >
                    <div className="px-7 pb-6 border-t border-[#111111]/5 pt-4">
                        <p
                ...
                <div className="container">
                    ...
                    <div className="flex justify-center gap-3 mb-12 flex-wrap">
                        {[
                            ...
                            { id: "lashes-brows", label: "Eyelashes & Brows" },
                            ...
                            <button
                                ...
                                className={`pricing-tab-btn px-6 py-2.5 rounded-full text-[11px] font-bold uppercase tracking-[1.5px] border cursor-pointer ${
                                    activeTab === tab.id 
